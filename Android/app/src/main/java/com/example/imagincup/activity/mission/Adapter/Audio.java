package com.example.imagincup.activity.mission.Adapter;
...
public class Audio extends RecyclerView.Adapter{
    /*
  어댑터의 동작원리 및 순서
  ...
  */
    ...
    public Audio(Context context, ArrayList<Uri> dataModels) {
